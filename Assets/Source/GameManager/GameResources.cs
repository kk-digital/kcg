...
public class GameResources
{
    ...
    public static void CreateItems(Contexts entitasContext)
    {
        ...
        Item.CreationApi.Instance.SetFireWeapon(20.0f, 1f, 10.0f, 25.0f, new Vec2f(0.2f, 0.2f), OreIcon);
        Item.CreationApi.Instance.SetFireWeaponClip(8, 1f);
        Item.CreationApi.Instance.SetSize(new Vec2f(0.5f, 0.5f));
        Item.CreationApi.Instance.SetAction(Enums.ActionType.ToolActionFireWeapon);
        ...
        Item.CreationApi.Instance.SetSize(new Vec2f(0.5f, 0.5f));
        Item.CreationApi.Instance.SetAction(Enums.ActionType.ToolActionRemoveTile);
        Item.CreationApi.Instance.EndItem();
        ...
        Item.CreationApi.Instance.SetSize(new Vec2f(0.5f, 0.5f));
        Item.CreationApi.Instance.SetAction(Enums.ActionType.ToolActionEnemySpawn);
        Item.CreationApi.Instance.EndItem();
        ...
        Item.CreationApi.Instance.SetSize(new Vec2f(0.5f, 0.5f));
        Item.CreationApi.Instance.SetAction(Enums.ActionType.ToolActionMiningLaser);
        Item.CreationApi.Instance.EndItem();
        ...
        Item.CreationApi.Instance.SetInventoryTexture(OreIcon);
        Item.CreationApi.Instance.SetSize(new Vec2f(0.5f, 0.5f));
        Item.CreationApi.Instance.SetAction(Enums.ActionType.ToolActionPlaceParticle);
        Item.CreationApi.Instance.EndItem();
    }
