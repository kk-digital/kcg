    ...
    public class ProcessCollisionSystem
    {
        public void Update(Planet.TileMap tileMap)
        {
            ...
            foreach (var entity in entities)
            {
                ...
                // Create Box Borders
                var entityBoxBorders = Box.Create(new Vec2f(pos.TempPosition.X, pos.Position.Y), size);
                ...
                entityBoxBorders = Box.Create(new Vec2f(pos.Position.X, pos.TempPosition.Y), size);
