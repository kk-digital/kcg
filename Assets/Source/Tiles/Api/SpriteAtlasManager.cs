...
namespace Tile
{
    public class SpriteAtlasManager
    {
        ...
        {
            ref Sprites.Atlas atlas = ref SpritesArray[0];
        ...
        {
            Sprites.Sheet sheet = GameState.SpriteLoader.SpriteSheets[spriteSheetID];
            ref Sprites.Atlas atlas = ref SpritesArray[atlasId];
