...
public class MiningLaser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        inventoryAttacher.AttachInventoryToAgent(contexts.game, inventoryWidth, inventoryHeight, playerEntity);
        inventoryAttacher.AttachToolBarToPlayer(contexts.game, toolBarSize, playerEntity);
