...
public partial class GameEntity {
    ...
    public Agent.AIController agentAIController { get { return (Agent.AIController)GetComponent(GameComponentsLookup.AgentAIController); } }
    public bool hasAgentAIController { get { return HasComponent(GameComponentsLookup.AgentAIController); } }
    ...
    public void AddAgentAIController(int newAgentPlannerID, System.Collections.Generic.Queue<int> newActionIDs, System.Collections.Generic.List<int> newGoalIDs, AI.GoapState newCurrentWorldState) {
        var index = GameComponentsLookup.AgentAIController;
    ...
    public void RemoveAgentAIController() {
        RemoveComponent(GameComponentsLookup.AgentAIController);
    }
}
...
public sealed partial class GameMatcher {
    ...
    static Entitas.IMatcher<GameEntity> _matcherAgentAIController;

    public static Entitas.IMatcher<GameEntity> AgentAIController {
        get {
            if (_matcherAgentAIController == null) {
                var matcher = (Entitas.Matcher<GameEntity>)Entitas.Matcher<GameEntity>.AllOf(GameComponentsLookup.AgentAIController);
