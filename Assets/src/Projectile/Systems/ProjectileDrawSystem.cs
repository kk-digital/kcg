...
namespace Systems
{
    public class ProjectileDrawSystem : IInitializeSystem, IExecuteSystem
    {
        // Entitas Context
        ...
        public ProjectileDrawSystem(Contexts contexts, string filePath, int width, int height, Transform transform, Material mat, ProjectileType projectileType,
        ...
        public void Initialize()
        {
            ...
            // Blit
            int imageSpriteIndex = GameState.SpriteAtlasManager.CopySpriteToAtlas(_spriteID, 0, 0, SpriteAtlas.AtlasType.Agent);
            // Calculating Bytes
            byte[] imageBytes = new byte[_width * _height * 4];

            // Get Sprite Bytes
            GameState.SpriteAtlasManager.GetSpriteBytes(imageSpriteIndex, imageBytes, SpriteAtlas.AtlasType.Agent);
